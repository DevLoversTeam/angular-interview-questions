...
2. Несумісність сторонніх бібліотек
...
4. Зміни в архітектурі (Angular 16+ → 20+)

- Перехід на standalone components
- Менше NgModules
- Нові підходи (signals, inject())

**Проблема:** legacy-код виглядає застарілим **Рішення:** мігрувати поступово,
не все одразу
...
Основні проблеми при оновленні Angular - це breaking changes, несумісні
бібліотеки, строгіші типи та legacy-архітектура. Вирішуються поетапним
